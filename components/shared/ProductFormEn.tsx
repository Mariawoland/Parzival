...
import { createProduct } from "@/lib/actions/productEn.actions"
...
const ProductFormEn = ({ userId, product, productId }: ProductFormProps) => {
    ...
    async function onSubmit(values: z.infer<typeof ProductFormSchema>) {
        ...
        try {
            ...
            if (newProduct) {
                form.reset();
                router.push(`/productsEn/${newProduct._id}`)
            }
        } catch (error) {
            console.log(error);
        }
    ...
    return (
        <>
            <div className="lg:w-1/2 w-full px-5 m-auto mt-10">
                <h1 className="text-lg font-black text-two-1 pb-5 ps-1">პროდუქტის დამატება inglisurad</h1>
                <Form {...form}>
